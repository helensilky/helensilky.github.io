...
$to = "asiasko@yandex.by"; // Add your email address inbetween the '' replacing yourname@yourdomain.com - This is where the form will send a message to.
$email_subject = "Новое сообщение с контактной формы от:  $name";
$email_body = "Вы получили новое сообщение от контактной формы сайта MWS.BY.\n\n"."
